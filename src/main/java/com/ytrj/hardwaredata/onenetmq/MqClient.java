...
public class MqClient {
    ...
    public synchronized boolean connect(){
        ...
        try {
            ...
            client.setCallback(new com.ytrj.hardwaredata.onenetmq.PushCallback(this));
            try {
    ...
    private void resetOptions(){
        ...
        try {
            //生成token
            password = com.ytrj.hardwaredata.onenetmq.Token.assembleToken(version, resourceName, expirationTime, signatureMethod, accessKey);
        ...
        try {
            options.setSocketFactory(com.ytrj.hardwaredata.utils.SslUtil.getSocketFactory(caCrtFile));
